...
describe('FootballPLayerList Component', () => {
    ...
    it('should render FootballPlayerList without throwing an error', () => {
        ...
        let mount = shallow(<FootballPlayerList footballPlayers={mockPlayersWithAge} />);

        //Mounted the componenet
        expect(mount.find('table')).toBeDefined();

        expect(mount.type()).toEqual('table');

    })

    // make our assertion and what we expect to happen 
    it('should render FootballPlayerList with empty array without throwing an error', () => {
        let mockPlayersWithAgeEmpty = [];
        let mount = shallow(<FootballPlayerList footballPlayers={mockPlayersWithAgeEmpty} />);
